...
私が記事のタイトルを与えたら、まずはschemeに準拠した大見出しと字下げした小見出しの構成で目次を作成して下さい。その次に目次に適した原稿を200文字~500文字程度で「1.イントロダクション」から書き出して下さい。記事の作成は上記のフォーマットと絶対に一致して下さい、しかもお題に適したコンテンツを作成して下さい。！と指示したら続きを書いて下さい。
