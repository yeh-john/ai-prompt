...
お題""が与えられたら、まずはschemeに準拠した大見出しと字下げした小見出しの構成で目次を作成して下さい。次に目次に適した原稿を200文字~500文字程度で1.イントロダクションから作成して下さい。記事の作成は上記のフォーマットと一致しなければなりませんが、お題に適したコンテンツを作成して下さい。！と指示したら続きを書いて下さい。
